...
const AddOrders: React.FC = () => {
  ...
  return (
    ...
    >
      <div className="p-6 max-w-xl mx-auto bg-white bg-opacity-90 rounded shadow-lg">
        <h2 className="text-2xl font-bold mb-6 text-center text-gray-800">Place New Order</h2>
